...
//        taIntroduction.setFont(new Font(Font.DIALOG, Font.PLAIN, 16));
        return textArea;
    }
        ...
        switch (parentFrame.getOptions().getLanguage()) {
            ...
            case 1 -> {
                ...
                textArea.append("    Для импорта измерений из файла измерений Вашего ХХХХ тахеометра перейдите на вкладку \"Измерения\"" +
                        ...
                        " диске Вашего компьютера. В случае успешного импорта Taheoport предложит сохранить на диске измерения в собственном" +
